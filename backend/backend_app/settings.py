...
EMAIL_INVITE_EMPLOYER_URL = "%s://%s/account/invite/{uid}/{token}/{company_uid}" % (HTTP, HOST)
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=int(os.getenv('REFRESH_TOKEN_LIFETIME', 3))),
