...
from .views import EmailPasswordLoginView, LogoutView, CookieTokenRefreshView, GoogleLoginView, YandexLoginView, \
    RegisterView, EmailActivationView, EmailResendActivationView, ConfirmResetPasswordView, ResetPasswordView
...
urlpatterns = [
    ...
    path('activate/resend/', EmailResendActivationView.as_view(), name='activate-resend'),
